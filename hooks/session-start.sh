...
CLA_LINE="Claude 5h:残${CLA_5H_REMAINING_PCT}% 週:残${CLA_7D_REMAINING_PCT}% Sonnet週:残${CLA_7D_SONNET_REMAINING_PCT}%${SNT_WARN}"
CDX_LINE="Codex 5h:残${CDX_5H_REMAINING_PCT%.*}% 週:残${CDX_WEEK_REMAINING_PCT%.*}%"
